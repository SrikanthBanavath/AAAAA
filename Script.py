...
Mʏ Nᴀᴍᴇ <a href=https://t.me/{}>{}</a></blockquote>
...
Jᴜsᴛ Sᴇɴᴅ Mᴇ Mᴏᴠɪᴇ/Sᴇʀɪᴇs Nᴀᴍᴇ</b>"""
...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/CinemasMawa/5)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
...
my features Stay here new features coming soon...  
 <b>✯ Maintained by : <a href=https://t.me/Srikanth_Official_Bot>𝗦𝗥𝗜𝗞𝗔𝗡𝗧𝗛 𝗡𝗔𝗬𝗔𝗞</a></b>
  
 <b>✯ Join here : <a href=https://t.me/CinemasMawa>Join Updates Channel</a></b> 
 ...
 ./song - Download any song [<code>example /song Fear song </code>] 
...
ஏய் <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 படி 1: இந்த BOT நிர்வாகியை உங்கள் குழுவில் உருவாக்கவும்

 படி 2: உங்கள் இணையதளம் மற்றும் API ஐச் சேர்க்கவும்

 காலாவதி: /shortlink omegalinks.in 4b392f8eb6ad711fbe58
...
హే <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 దశ 1: మీ గ్రూప్‌లో ఈ BOT అడ్మిన్‌ని చేయండి
...
अरे <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 चरण 1: इस BOT को अपने ग्रुप में एडमिन बनाएं
...
ഹേയ് <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 ഘട്ടം 1: നിങ്ങളുടെ ഗ്രൂപ്പിൽ ഈ BOT അഡ്മിൻ ആക്കുക
...
നിങ്ങളുടെ ടീം വീഡിയോ ശേഖരണവും പരിശീലിപ്പിക്കും..."""
    ...
    URTU_INFO = """
 ارے <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 مرحلہ 1: اپنے گروپ میں اس BOT ایڈمن بنائیں
...
نیز آپ کی ٹیم ویڈیو جمع کرنے کی تربیت دے گی..."""
    ...
    GUJARATI_INFO = """
હેય <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 પગલું 1: તમારા જૂથમાં આ BOT એડમિન બનાવો
...
ಹೇ <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 ಹಂತ 1: ನಿಮ್ಮ ಗುಂಪಿನಲ್ಲಿ ಈ BOT ನಿರ್ವಾಹಕರಾಗಿ
...
আরে <a href='tg://settings'>ᴍʏ ғʀɪᴇɴᴅ</a> 
 ...
 ধাপ 1: আপনার গ্রুপে এই BOT অ্যাডমিন করুন
...
-Dev 1 [Owner of this bot ]<a href='https://t.me/Srikanth_Official_Bot'>Srikanth Naik</a>
"""
